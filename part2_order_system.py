...
subtotal = 0
for c in cart:
    total_item = c["quantity"] * c["price"]
    subtotal += total_item
    print(c["item"], "x", c["quantity"], "=", total_item)
...
#changing value to show deep copy
...
#finding out the most ordered item
count = {}
for day in sales_log:
    for order in sales_log[day]:
